...
INSERT INTO universities(scholarships, rating, name)
    SELECT true, i, 'university_' || i FROM generate_series(501, 100000) i;
...
EXPLAIN SELECT COUNT(*) FROM universities WHERE rating > 0;

SELECT rating from universities;
